...
const (
	...
	// V1AwsCloudAccountCredentialTypePodIdentity captures enum value "pod-identity"
	V1AwsCloudAccountCredentialTypePodIdentity V1AwsCloudAccountCredentialType = "pod-identity"
)
