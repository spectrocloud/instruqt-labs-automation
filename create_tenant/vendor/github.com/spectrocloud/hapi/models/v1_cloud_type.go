...
const (
	...
	// V1CloudTypeApacheCloudstack captures enum value "apache-cloudstack"
	V1CloudTypeApacheCloudstack V1CloudType = "apache-cloudstack"
...
func init() {
	var res []V1CloudType
	if err := json.Unmarshal([]byte(`["all","aws","azure","gcp","vsphere","maas","nested","baremetal","eks","aks","edge","apache-cloudstack","edge-native","generic","gke"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
