...
// V1SystemPasswordPolicySpec system password policy
//
// swagger:model v1SystemPasswordPolicySpec
type V1SystemPasswordPolicySpec struct {
...
// Validate validates this v1 system password policy spec
func (m *V1SystemPasswordPolicySpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1SystemPasswordPolicySpec) validateCreationTimestamp(formats strfmt.Registry) error {
...
func (m *V1SystemPasswordPolicySpec) validateUpdateTimestamp(formats strfmt.Registry) error {
...
func (m *V1SystemPasswordPolicySpec) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1SystemPasswordPolicySpec) UnmarshalBinary(b []byte) error {
	var res V1SystemPasswordPolicySpec
