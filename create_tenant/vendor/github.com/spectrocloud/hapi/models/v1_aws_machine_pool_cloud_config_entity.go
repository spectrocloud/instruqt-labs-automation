...
const (
	...
	// V1AwsMachinePoolCloudConfigEntityCapacityTypeHostResourceGroup captures enum value "host-resource-group"
	V1AwsMachinePoolCloudConfigEntityCapacityTypeHostResourceGroup string = "host-resource-group"
)
