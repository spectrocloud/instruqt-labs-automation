...
type V1SpectroClusterFilterSpec struct {
	...
	// cluster templates
	// Unique: true
	ClusterTemplates []string `json:"clusterTemplates"`
...
func (m *V1SpectroClusterFilterSpec) validateClusterTemplates(formats strfmt.Registry) error {

	if swag.IsZero(m.ClusterTemplates) { // not required
		return nil
	}

	if err := validate.UniqueItems("clusterTemplates", "body", m.ClusterTemplates); err != nil {
		return err
	}
