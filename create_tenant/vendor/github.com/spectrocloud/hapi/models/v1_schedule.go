...
func (m *V1Schedule) validateDurationHrs(formats strfmt.Registry) error {
	...
	if err := validate.MinimumInt("durationHrs", "body", int64(*m.DurationHrs), 1, false); err != nil {
		return err
	}

	if err := validate.MaximumInt("durationHrs", "body", int64(*m.DurationHrs), 24, false); err != nil {
		return err
	}
