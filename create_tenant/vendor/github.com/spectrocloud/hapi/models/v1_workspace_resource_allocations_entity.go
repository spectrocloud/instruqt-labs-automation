...
// V1WorkspaceResourceAllocationsEntity Workspace resource allocation update entity
//
// swagger:model v1WorkspaceResourceAllocationsEntity
type V1WorkspaceResourceAllocationsEntity struct {
...
// Validate validates this v1 workspace resource allocations entity
func (m *V1WorkspaceResourceAllocationsEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *V1WorkspaceResourceAllocationsEntity) validateClusterNamespaces(formats strfmt.Registry) error {
...
func (m *V1WorkspaceResourceAllocationsEntity) validateClusterRefs(formats strfmt.Registry) error {
...
func (m *V1WorkspaceResourceAllocationsEntity) validateQuota(formats strfmt.Registry) error {
...
func (m *V1WorkspaceResourceAllocationsEntity) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *V1WorkspaceResourceAllocationsEntity) UnmarshalBinary(b []byte) error {
	var res V1WorkspaceResourceAllocationsEntity
