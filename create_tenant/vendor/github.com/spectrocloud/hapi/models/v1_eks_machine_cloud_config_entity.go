...
const (
	...
	// V1EksMachineCloudConfigEntityCapacityTypeHostResourceGroup captures enum value "host-resource-group"
	V1EksMachineCloudConfigEntityCapacityTypeHostResourceGroup string = "host-resource-group"
)
