...
resource "spectrocloud_cluster_profile" "infra_k8s-1-1-27" {
  ...
  pack {
    name   = data.spectrocloud_pack.k8s-1-1-27.name
    tag    = local.k8s-1-1-27_version
    uid    = data.spectrocloud_pack.k8s-1-1-27.id
    values = data.spectrocloud_pack.k8s-1-1-27.values
  }
