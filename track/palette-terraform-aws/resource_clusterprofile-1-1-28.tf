...
resource "spectrocloud_cluster_profile" "infra_k8s-1-1-28" {
...
pack {
    name   = data.spectrocloud_pack.k8s-1-1-28.name
    tag    = local.k8s-1-1-28_version
    uid    = data.spectrocloud_pack.k8s-1-1-28.id
    values = data.spectrocloud_pack.k8s-1-1-28.values
  }
