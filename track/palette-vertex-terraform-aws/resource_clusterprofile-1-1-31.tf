...
resource "spectrocloud_cluster_profile" "infra_k8s-1-1-31" {
  ...
  pack {
    name   = data.spectrocloud_pack.k8s-1-1-31.name
    tag    = local.k8s-1-1-31_version
    uid    = data.spectrocloud_pack.k8s-1-1-31.id
    values = data.spectrocloud_pack.k8s-1-1-31.values
  }
