...
resource "spectrocloud_cluster_profile" "infra_k8s-1-1-32" {
  ...
  pack {
    name   = data.spectrocloud_pack.k8s-1-1-32.name
    tag    = local.k8s-1-1-32_version
    uid    = data.spectrocloud_pack.k8s-1-1-32.id
    values = data.spectrocloud_pack.k8s-1-1-32.values
  }
